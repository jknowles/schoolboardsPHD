...
- Serve an administrative unit that is often not coterminous with other units
...
>- Turnout in board elections, while reduced, has *many of the same* predictors 
as national and state elections
...
- Measurement challenges with both independent and dependent variables
