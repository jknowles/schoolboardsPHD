...
general election races, \Sexpr{\Sexpr{iNum(length(races$distid[races$electiontype == 2]))}} 
primary election races, and \Sexpr{\Sexpr{iNum(length(races$distid[races$electiontype == 3]))}} 
