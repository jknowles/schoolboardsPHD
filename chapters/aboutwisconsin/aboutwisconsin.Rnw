...
races.tmp$contest <- "No Contested Incumbent"
races.tmp$contest[races.tmp$nrealcand > races.tmp$ninc] <- "Incumbent Contested"
...
incumbent are contested more often than we might think.
