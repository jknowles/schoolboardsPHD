...
races.tmp$turnout <- races.tmp$votes / races.tmp$VAP_adj # need to define VAP_adj
...
races.tmp$turnout2 <- races.tmp$votes / races.tmp$topPresVotesPrior
...
turnoutPerEst <- (turnoutEst / vapEst)*100
