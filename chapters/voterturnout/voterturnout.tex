...
I leverage a unique dataset consisting of school board election returns for 
several hundred Wisconsin school districts from 2007-2012. 
...
have found some evidence that economic conditions influence voting patterns \citep{EconandOutcomes2000}. 
...
$M_{t}$ is the margin of victory for candidates in the school board election. 

\[(3) \hspace{0.4 in}  VP_{t} = \alpha + \beta X_{lag} + \theta S_{t} + \psi Ce_{t} + \epsilon \] \\

$S_{t}$ is the total size of the electorate. 

\[(4) \hspace{0.4 in}  VP_{t} = \alpha + \beta X_{lag} + \theta S_{t} *\theta M_{t} + \psi Ce_{t} + \epsilon \] \\

The interaction of size and margin of victory. 

\[(5) \hspace{0.4 in}  VP_{t} = \alpha + \beta X_{lag} + \theta S_{t} 
+ \gamma P_{t} + \psi Ce_{t} + \epsilon \] \\

$P_{t}$ represents a measure of the polarization in the community. 

\subsection{The Impact of Salience and Information on Voter Turnout}

To estimate these effects, we estimate an equation like below: \\
