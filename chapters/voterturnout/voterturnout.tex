...
sections. The turnout literature asks two fundamental questions -- why does 
...
rewarded, they lose some of their preference for voting

In school boards there is evidence that such socialization has occurred in the case of 
conservative Christians \citep{RefWorks:240}, unionized teachers [chapter 5][]\citep{RefWorks:249, RefWorks:207}, 
...
Major questions that can be explored by analyzing small scale elections in WI:
- Does the closeness of the election/margin relate to turnout ala \citep{Coate2008582}
- Does the size of the electorate affect turnout? 
- Does relative group size affect the turnout? (Can investigate traditional partisanship, but not other methods)
- Is turnout sticky?

Throw the bums out. Dahl to Alsbury. 

Dissatisfaction theory is the closest link in the school board literature to 
larger political science theories of voter turnout. 
...
in Wisconsin became suddenly extremely polarized. In addition to the sudden 
...
voters in local elections. If there is no impact on voter turnout in the wake 
of such a broad expansion of school board power over an issue as polarizing as 
collective bargaining rights for local employees, we would expect smaller policy 
shocks to have no effect either. 

\subsection{How School Board Elections are Different}
...
%% Write up the method for the descriptive analysis
%% Write up method for causal analysis
