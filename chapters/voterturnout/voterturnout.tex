...
##    Data: moddat
## 
## REML criterion at convergence: -4755
## 
## Scaled residuals: 
##    Min     1Q Median     3Q    Max 
## -4.398 -0.598 -0.117  0.489  7.987 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  distid   (Intercept) 0.00135  0.0368  
##  Residual             0.00699  0.0836  
## Number of obs: 2390, groups:  distid, 309
## 
## Fixed effects:
##                    Estimate Std. Error t value
## (Intercept)        -1.01945    0.18149   -5.62
## turnoutLag2         0.11958    0.02202    5.43
## fallTurnout         0.10920    0.03996    2.73
## log(VAP_adj)       -0.02575    0.00299   -8.62
## per_white_all      -0.07334    0.03811   -1.92
## per65o              0.38103    0.08903    4.28
## PerBachelorOrAbove -0.11935    0.07586   -1.57
## OOH_share          -0.01640    0.03092   -0.53
## log(PCI)            0.13537    0.01897    7.14
## 
## Correlation of Fixed Effects:
##             (Intr) trntL2 fllTrn l(VAP_ pr_wh_ per65o PrBcOA OOH_sh
## turnoutLag2 -0.086                                                 
## fallTurnout  0.112 -0.057                                          
## log(VAP_dj) -0.278  0.219  0.080                                   
## per_whit_ll -0.088  0.005 -0.131  0.076                            
## per65o       0.123 -0.075 -0.046  0.133 -0.223                     
## PrBchlrOrAb  0.625 -0.061 -0.432 -0.282  0.144  0.240              
## OOH_share    0.156  0.020 -0.127  0.128 -0.354  0.630  0.192       
## log(PCI)    -0.960  0.046 -0.182  0.092 -0.051 -0.236 -0.612 -0.244
\end{verbatim}
\end{kframe}
\end{knitrout}
