...
\includegraphics[width=\maxwidth]{../../phd_figs/chap4-turnoutCompetitive} \caption[Turnout in School Board Elections based on Competitiveness]{Turnout in School Board Elections based on Competitiveness\label{fig:turnoutCompetitive}}
\end{figure}
