...
library(rms)
library(apsrtable)
moddat <- moddat[moddat$outflag <= 5,]
dd <<- datadist(moddat)
options(datadist="dd")
...
apsrtable(naive1, dumbRLM1, dumbRLM1.2, dumbRLM2, se="robust", label="tab:lagmods", 
...
# }
# 
mixedMod1 <- lmer(turnout ~ turnoutLag2 + fallTurnout + VAP_adj + per_white_all +
...
library(stargazer)
stargazer(mixedMod1, title = "Partial Pooling Model of Lagged Turnout", style = "apsr", 
            label = "tab:meTurnout")
...
# summary(mixedMod2)
stargazer(mixedMod2, title = "Partial Pooling Model of Competitiveness", style = "apsr", 
            label = "tab:meClose")
...
# summary(mixedMod3)
stargazer(mixedMod3, title = "Partial Pooling Model of Staff Influence", style = "apsr", 
            label = "tab:meInf")
@
...
dist_turn <- merge(dist_turn, springVotes[, c(1, 2, 5)], 
                   by = c("distid", "year"))
