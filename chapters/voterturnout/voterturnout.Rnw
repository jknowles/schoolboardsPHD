...
turn21 <- ols(turnout ~ turnoutLag1 + fallTurnout + log(VAP_adj) + per_white_all + 
                  per65o + PerBachelorOrAbove + OOH_share + log(PCI), 
              data = moddat, x = TRUE, y = TRUE)
...
turn22 <- ols(turnout ~ turnoutLag1 + fallTurnout + log(VAP_adj) + per_white_all + 
                    per65o + PerBachelorOrAbove + OOH_share + log(PCI) +
                    factor(year),
              data = moddat, x= TRUE, y = TRUE)
...
turn23 <- ols(turnout ~ turnoutLag1 + fallTurnout + log(VAP_adj) + per_white_all +
                   per65o + PerBachelorOrAbove + OOH_share + log(PCI) +
                  factor(distid), 
              data = moddat, x = TRUE, y = TRUE)
...
# }
# 
mixedMod1 <- lmer(turnout ~ turnoutLag2 + fallTurnout + log(VAP_adj) + per_white_all +
