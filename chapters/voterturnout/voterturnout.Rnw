...
moddat <- dist_turn[, c("turnout", "turnoutLag2", "turnoutLag1","year", "contest",
                        ...
                        "per_white_all", "per65o", "PerBachelorOrAbove", "OOH_share", "PCI")]
...
moddat$PCI <- log(moddat$PCI)

naive1 <- lm(turnout ~ turnoutLag2 + fallTurnout + VAP_adj + per_white_all + 
                       per65o + PerBachelorOrAbove + OOH_share + PCI + districtwide + 
               contest,
             data = moddat)
...
#                    per65o + PerBachelorOrAbove + OOH_share + log(PCI) +
#                   factor(distid), 
#               data = moddat, x = TRUE, y = TRUE)
# 
...
stargazer(mixedMod1b, title = "Partial Pooling Model of Lagged Turnout", style = "apsr", 
            label = "tab:meTurnout", notes = tabnote)
...
# summary(mixedMod2)
stargazer(mixedMod2b, title = "Partial Pooling Model of Competitiveness", style = "apsr", 
            label = "tab:meClose")
...
# summary(mixedMod3)
stargazer(mixedMod3b, title = "Partial Pooling Model of Staff Influence", style = "apsr", 
            label = "tab:meInf")
@
...
stargazer(undvote1, title = "Partial Pooling Model of School Board Undervote", 
          style = "apsr", 
            label = "tab:meInf")
...
stargazer(mixedModCaus, title = "Partial Pooling Model of Post-Election Polarization", 
          style = "apsr", 
            label = "tab:meInf")
...
stargazer(mixedMod1b, mixedMod2b, mixedMod3b, mixedModCaus, style = "apsr", 
          label = "tab:modReview")
@
