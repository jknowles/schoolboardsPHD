...
\begin{verbatim}
## Parametric bootstrap test; time: 2010.19 sec; samples: 200 extremes: 0;
## Requested samples: 200 Used samples: 117 Extremes: 0
...
##          stat df   p.value    
## LRT    100.45  0 < 2.2e-16 ***
## PBtest 100.45     0.008475 ** 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## Parametric bootstrap test; time: 1437.35 sec; samples: 200 extremes: 0;
## Requested samples: 200 Used samples: 0 Extremes: 0
## large : contestSer ~ VAP_adjLOG + per65o + median_incomeLOG + per_white_all + 
##     OOH_share + (1 | year/distid)
## small : contestSer ~ VAP_adjLOG + per65o + median_incomeLOG + per_white_all + 
##     OOH_share + (1 | distid)
...
## LRT    -96.216  1       1
## PBtest -96.216          1
## Parametric bootstrap test; time: 5779.46 sec; samples: 200 extremes: 0;
...
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## Parametric bootstrap test; time: 5595.38 sec; samples: 200 extremes: 0;
## Requested samples: 200 Used samples: 0 Extremes: 0
## large : contestSer ~ VAP_adjLOG + per65o + median_incomeLOG + per_white_all + 
##     OOH_share + schoolMillShare + PROPERTYTAX_REV_SHARE + TCEC_MEMBER + 
##     balance_member_lag + millrate_delta + (1 | year/distid)
...
## LRT    -93.673  1       1
## PBtest -93.673          1
## Parametric bootstrap test; time: 8031.59 sec; samples: 200 extremes: 0;
## Requested samples: 200 Used samples: 41 Extremes: 0
## large : contestSer ~ VAP_adjLOG + per65o + median_incomeLOG + per_white_all + 
...
##          stat df p.value    
## LRT    90.378  0 < 2e-16 ***
## PBtest 90.378    0.02381 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## Parametric bootstrap test; time: 7564.83 sec; samples: 200 extremes: 0;
## Requested samples: 200 Used samples: 0 Extremes: 0
## large : contestSer ~ VAP_adjLOG + per65o + median_incomeLOG + per_white_all + 
##     OOH_share + incumShare + overrideYesPer + fallTwoPartyShareDem + 
##     teachShareofVoters + fallTurnout + nraces + (1 | year/distid)
...
## LRT    -87.959  1       1
## PBtest -87.959          1
## Parametric bootstrap test; time: 5994.37 sec; samples: 200 extremes: 0;
## Requested samples: 200 Used samples: 30 Extremes: 0
## large : contestSer ~ VAP_adjLOG + per65o + median_incomeLOG + per_white_all + 
...
##          stat df p.value    
## LRT    91.894  0 < 2e-16 ***
## PBtest 91.894    0.03226 *  
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## Parametric bootstrap test; time: 5892.38 sec; samples: 200 extremes: 0;
## Requested samples: 200 Used samples: 0 Extremes: 0
## large : contestSer ~ VAP_adjLOG + per65o + median_incomeLOG + per_white_all + 
##     OOH_share + ADMIN_SHARE_COMP + NEW_SUP + NonPublicPupilPer + 
##     DEBT_ATTEMPT_CUMUL93 + OVERRIDE_ATTEMPT_CUMUL93 + (1 | year/distid)
