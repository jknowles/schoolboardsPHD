...
demogModel2 <- glm(contest2 ~ VAP_adjLOG + PerBachelorOrAbove + per_white_all + 
                    ...
                    NonWhitePublicPupilPer + NonPublicPupilPer + 
                    teachShareofVoters + locale2 + member_delta_per + 
                     factor(year) + factor(districtwide), 
                  data = moddat, family = "binomial")
...
apsrtable(demogModel, demogModel2, demogModel3, se = "vcov", float = "sidewaystable",
          label="tab:demogmods", 
...
apsrtable(demogModelPP, demogModelPP2, demogModelPP3,
          model.names = c("Demog + Year Eff.", 
                          "Demog + District Eff.", 
                          "Demog + Year + District Eff."),
