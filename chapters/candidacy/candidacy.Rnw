...
apsrtable(demogModel, demogModel2, demogModel3, se = "vcov", 
          float = "sidewaystable",
          label="tab:demogmods", 
          model.names=c("Simple Demog.", "Demog + Year FE", 
                        "Demog + District FE"), 
...
fiscalModelPP <- bglmer(contest2 ~ balance_member_lag + millrate * NonSDMill + 
                     overridePass + debtPass + refInPlace + median_incomeLOG + 
                     millrate_delta + VAP_adjLOG + 
                     DEBT_ATTEMPT_CUMUL93 + eqv_member + teachSalDiff +
...
fiscalModelPP2 <- bglmer(contest2 ~ balance_member_lag + millrate * NonSDMill + 
                     overridePass + debtPass + refInPlace + median_incomeLOG + 
                     millrate_delta + VAP_adjLOG + 
                     DEBT_ATTEMPT_CUMUL93 + eqv_member + teachSalDiff +
...
fiscalModelPP3 <- bglmer(contest2 ~ balance_member_lag + millrate * NonSDMill + 
                     overridePass + debtPass + refInPlace + median_incomeLOG + 
                     millrate_delta + VAP_adjLOG + 
                     DEBT_ATTEMPT_CUMUL93 + eqv_member + teachSalDiff +
