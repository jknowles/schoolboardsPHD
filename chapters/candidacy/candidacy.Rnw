...
<<buildingDV>>=
dist_turn$contest1 <- "Uncontested"
dist_turn$contest1[dist_turn$nrealcand > dist_turn$nwins] <- "Contested"
dist_turn$contest2 <- "Uncontested"
dist_turn$contest2[(dist_turn$nrealcand - dist_turn$nminor) > dist_turn$nwins] <- "Contested"
dist_turn$contest2 <- factor(dist_turn$contest2)
dist_turn$contest1 <- factor(dist_turn$contest1)
...
moddat <- dist_turn[, c("contest2", "contest1", "distid","year", 
                        "balance_member_lag", 
...
demogModel <- glm(contest2 ~ VAP_adjLOG + PerBachelorOrAbove + per_white_all + 
                    OOH_share + median_incomeLOG + per65o + 
                    NonWhitePublicPupilPer + NonPublicPupilPer + 
...
demogModel2 <- glm(contest2 ~ VAP_adjLOG + PerBachelorOrAbove + per_white_all + 
                    OOH_share + median_incomeLOG + per65o + 
                    NonWhitePublicPupilPer + NonPublicPupilPer + 
                    teachShareofVoters + locale2 + member_delta_per + 
...
demogModel3 <- glm(contest2 ~ VAP_adjLOG + PerBachelorOrAbove + per_white_all + 
                    OOH_share + median_incomeLOG + per65o + 
                    NonWhitePublicPupilPer + NonPublicPupilPer + 
                    teachShareofVoters + locale2 + member_delta_per + 
                     districtwide + distid, 
...
demogModel4 <- glm(contest1 ~ VAP_adjLOG + PerBachelorOrAbove + per_white_all + 
                    OOH_share + median_incomeLOG + per65o + 
                    NonWhitePublicPupilPer + NonPublicPupilPer + 
                    teachShareofVoters + locale2 + member_delta_per + 
                     districtwide + distid, 
...
demogModelPP1 <- glmer(contest2 ~ VAP_adjLOG + PerBachelorOrAbove + per_white_all + 
                    OOH_share + median_incomeLOG + per65o + 
                    NonWhitePublicPupilPer + NonPublicPupilPer + 
                    teachShareofVoters + locale2 + member_delta_per + 
                     (1|distid), 
...
demogModelPP2 <- glmer(contest1 ~ VAP_adjLOG + PerBachelorOrAbove + per_white_all + 
                    OOH_share + median_incomeLOG + per65o + 
                    NonWhitePublicPupilPer + NonPublicPupilPer + 
                    teachShareofVoters + locale2 + member_delta_per + 
                     (1|distid), 
...
# 
# demogModelPP <- bglmer(contest2 ~ VAP_adjLOG + PerBachelorOrAbove + per_white_all + 
#                     OOH_share + median_incomeLOG + per65o + 
#                     NonWhitePublicPupilPer + NonPublicPupilPer + 
#                     teachShareofVoters + locale2 + member_delta_per + 
#                      (1|distid), 
...
# demogModelPP2 <- bglmer(contest2 ~ VAP_adjLOG + PerBachelorOrAbove + 
#                           per_white_all + 
#                     OOH_share + median_incomeLOG + per65o + 
#                     NonWhitePublicPupilPer + NonPublicPupilPer + 
#                     teachShareofVoters + locale2 + member_delta_per + 
...
#                   cov.prior = wishart)
# 
# demogModelPP3 <- bglmer(contest2 ~ VAP_adjLOG + PerBachelorOrAbove + 
#                           per_white_all + 
#                     OOH_share + median_incomeLOG + per65o + 
#                     NonWhitePublicPupilPer + NonPublicPupilPer + 
#                     teachShareofVoters + locale2 + member_delta_per + 
...
fiscalModel <- glm(contest2 ~ balance_member_lag + millrate * NonSDMill + 
...
fiscalModel2 <- glm(contest2 ~ balance_member_lag + millrate * NonSDMill + 
                     overridePass + debtPass + refInPlace + median_incomeLOG + 
                     millrate_delta + VAP_adjLOG + 
                     DEBT_ATTEMPT_CUMUL93 + eqv_member + teachSalDiff +
...
fiscalModel3 <- glm(contest2 ~ balance_member_lag + millrate * NonSDMill + 
                     overridePass + debtPass + refInPlace + median_incomeLOG + 
                     millrate_delta + VAP_adjLOG + 
                     DEBT_ATTEMPT_CUMUL93 + eqv_member + teachSalDiff +
...
fiscalModelPP <- glmer(contest2 ~ balance_member_lag + millrate * NonSDMill + 
                     overridePass + debtPass + refInPlace + median_incomeLOG + 
                     millrate_delta + VAP_adjLOG + 
                     DEBT_ATTEMPT_CUMUL93 + eqv_member + teachSalDiff +
...
fiscalModelPP2 <- glmer(contest2 ~ balance_member_lag + millrate * NonSDMill + 
                     overridePass + debtPass + refInPlace + median_incomeLOG + 
                     millrate_delta + VAP_adjLOG + 
                     DEBT_ATTEMPT_CUMUL93 + eqv_member + teachSalDiff +
...
fiscalModelPP3 <- glmer(contest1 ~ balance_member_lag + millrate *millrate_delta +  NonSDMill + 
                     overridePass + debtPass + refInPlace + median_incomeLOG + 
                     millrate_delta + VAP_adjLOG + 
                     DEBT_ATTEMPT_CUMUL93 + eqv_member + teachSalDiff +
                     OVERRIDE_ATTEMPT_CUMUL93 + (1|distid), 
...
politicModel <- glm(contest2 ~ SUP_TURNOVER_PRIOR_YEAR + turnoutLag1 + partyDivision + 
                      overrideQues +   debtQues + DEBT_ATTEMPT_CUMUL93 + 
                       OVERRIDE_ATTEMPT_CUMUL93 + ADJ_MEDIAN_SALARY_TEACHlog *
                      median_incomeLOG + fallTurnout + overrideYesPer, 
                    data = moddat, family = "binomial")

politicModel2 <- glm(contest2 ~ SUP_TURNOVER_PRIOR_YEAR + turnoutLag1 + partyDivision + 
                      overrideQues +   debtQues + DEBT_ATTEMPT_CUMUL93 + 
                       OVERRIDE_ATTEMPT_CUMUL93 + ADJ_MEDIAN_SALARY_TEACHlog *
                      median_incomeLOG + fallTurnout + overrideYesPer + 
                      year, 
...
politicModel3 <- glm(contest2 ~ SUP_TURNOVER_PRIOR_YEAR + turnoutLag1 + partyDivision + 
                      overrideQues +   debtQues + DEBT_ATTEMPT_CUMUL93 + 
                       OVERRIDE_ATTEMPT_CUMUL93 + ADJ_MEDIAN_SALARY_TEACHlog *
                      median_incomeLOG + fallTurnout + overrideYesPer + 
                      distid, 
...
politicModel4 <- glm(contest1 ~ SUP_TURNOVER_PRIOR_YEAR + turnoutLag1 + partyDivision + 
                      overrideQues +   debtQues + DEBT_ATTEMPT_CUMUL93 + 
                       OVERRIDE_ATTEMPT_CUMUL93 + ADJ_MEDIAN_SALARY_TEACHlog *
                      median_incomeLOG + fallTurnout + overrideYesPer + 
                      distid, 
...
politicModelPP <- glmer(contest2 ~ SUP_TURNOVER_PRIOR_YEAR + turnoutLag1 + partyDivision + 
                      overrideQues +   debtQues + DEBT_ATTEMPT_CUMUL93 + 
                       OVERRIDE_ATTEMPT_CUMUL93 + ADJ_MEDIAN_SALARY_TEACHlog *
                      median_incomeLOG + fallTurnout + overrideYesPer + (1|year), 
                   data = moddat, family = 'binomial', control = ctrl)

politicModelPP2 <- glmer(contest2 ~SUP_TURNOVER_PRIOR_YEAR + turnoutLag1 + partyDivision + 
                      overrideQues +   debtQues + DEBT_ATTEMPT_CUMUL93 + 
                       OVERRIDE_ATTEMPT_CUMUL93 + ADJ_MEDIAN_SALARY_TEACHlog *
...
politicModelPP3 <- glmer(contest1 ~SUP_TURNOVER_PRIOR_YEAR + turnoutLag1 + partyDivision + 
                      overrideQues +   debtQues + DEBT_ATTEMPT_CUMUL93 + 
                       OVERRIDE_ATTEMPT_CUMUL93 + ADJ_MEDIAN_SALARY_TEACHlog *
                      median_incomeLOG + fallTurnout + overrideYesPer + (1|distid), 
                   data = moddat, family = 'binomial', control = ctrl)
...
# politicModelPP3 <- bglmer(contest2 ~ NEW_SUP + turnoutLag1 + partyDivision + 
...
apsrtable(politicModelPP, politicModelPP2, politicModelPP3,
          model.names = c("Politics + Year Eff.", 
                          "Politics + District Eff.", 
                          "Politics + Year + District Eff."),
          caption = "Partial Pooling Model of Fiscal on Turnout",
...
<<erratta, eval=FALSE>>=
mod1 <- glm(contest2 ~ VAP_adjLOG + NEW_SUP + turnoutLag1 +partyDivision +
              PerBachelorOrAbove + per_white_all+
              OOH_share + median_incomeLOG + ADMIN_SHARE + 
              per65o + ADJ_MEDIAN_SALARY_TEACHlog + refInPlace+
              NonWhitePublicPupilPer *per_white_all+ overrideQues +
              millrate*NonSDMill + 
              overridePass + debtPass, 
            data = dist_turn, family = "binomial")
summary(mod1)


confusion.glm(dist_turn, glm(factor(contest2) ~ log(VAP_adj) + NEW_SUP + turnoutLag1 +fallTwoPartyShareDem +
              PerBachelorOrAbove + OOH_share + log(median_income) + ADMIN_SHARE + 
              NonWhitePublicPupilPer + overrideQues + millrate*NonSDMill, 
            data = dist_turn, family = "binomial"))
#moddat <- na.omit(moddat)
# Filter out extreme values

## Tax model -- voters are driven by tax concdrns
## Politics model -- voters are driven by political ideology
## Policy model -- teacher salary and benefits? 

tax_model <- glm(contested2 ~  millrate + cum_attptsD + overlevy_ind_lag +
                    per_white_all + levy_chg + log(Population18O) + 
                   ref_share +
                   balance_member_lag +  median_income + fyear, 
                 data=SBELEC[!is.na(SBELEC$contested2Lag1), ], 
                 family=binomial("logit"))

#summary(tax_model)
#sigma1 <- sum(residuals(tax_model, type = "pearson")^2) / df.residual(tax_model)

poli_model <- glm(contested2 ~ contested2Lag1 + primary2Lag1 +
                    cum_attptsD + per_white_all + per65o + log_politicaldivide +
                     fallTwoPartyShareDem +fallTurnout+
                    PerBachelorOrAbove +
                    median_income + log(Population18O) + fyear, 
                 data=SBELEC[!is.na(SBELEC$contested2Lag1), ], 
                 family=binomial("logit"))

#summary(poli_model)
SBELEC$average_fringe[SBELEC$average_fringe==0] <- 0.1
poly_model <- glm(contested2 ~ log(avg_salary) + log(average_fringe) + 
                    avg_total_exp + log(Population18O) + 
                    median_income +member_delta + total_attempts + fyear, 
                   data=SBELEC[!is.na(SBELEC$avg_salary), ], 
                  family = binomial("logit"))

#summary(poly_model)

uber_model <- glm(contested2 ~ log(dv_r) + avg_salary + average_fringe + 
                    avg_total_exp + log(Population18O) + contested2.lag1 +
                    median_income +member_delta + total_attempts + 
                    primary2.lag1 + cum_attptsD + perwhite + Per65over + 
                   attemptsD.lag1 + log_politicaldivide + PerBachelorOrAbove +
                    millrate + overlevy_ind_lag + toprepshare +
                    winshare.lag1 +
                    levy_chg + balance_member_lag + fyear, 
                   data=SBELEC[!is.na(SBELEC$contested2.lag1), ], 
                  family = binomial("logit"))
                   

makeROCdf <- function(model, name){
  predicted <- predict(model)
  prob <- prediction(predicted, model$model$contested2)
...
roc <- makeROCdf(tax_model, "tax")
roc2 <- makeROCdf(poli_model, "politics")
roc3 <- makeROCdf(poly_model, "policy")
roc4 <- makeROCdf(uber_model, "uber")
...
ggplot(roc) + geom_smooth(aes(x = fpr, y = tpr, color=mod), 
                          se=FALSE,size= I(1.1)) + 
...
qplot(contest1, RecallPolarization, data = moddat, geom = 'boxplot') + 
  facet_wrap(~year) +
  scale_y_continuous(label = percent) +
  theme_dpi()

qplot(turnout, RecallPolarization, data = moddat[moddat$turnout < 0.8,], color = contest1) + 
...
causal1 <- glm(contest1 ~ turnoutLag1 + VAP_adjLOG + per_white_all + 
...
causal2 <- glm(contest1 ~ turnoutLag1 + VAP_adjLOG + per_white_all + 
...
# causal3 <- glm(contest2 ~ turnoutLag1 + VAP_adjLOG + per_white_all + 
#                per65o + PerBachelorOrAbove + OOH_share + median_incomeLOG +
#                districtwide + RecallPolarization*treatment + 
...
mixedModCaus <- glmer(contest2 ~ turnoutLag1 + VAP_adjLOG + per_white_all + 
               per65o + PerBachelorOrAbove + OOH_share + median_incomeLOG +
               districtwide + RecallPolarization*treatment + turnout_overall_werc +
               treatment + (1|distid), 
              data = moddat, family = 'binomial', control = ctrl)

mixedModCaus2 <- glmer(contest2 ~ turnoutLag1 + VAP_adjLOG + per_white_all + 
                        topTicketTurnoutSpring +
               per65o + PerBachelorOrAbove + OOH_share + median_incomeLOG +
               districtwide + RecallPolarization*treatment + 
               treatment + turnout_overall_werc + (1|distid), 
