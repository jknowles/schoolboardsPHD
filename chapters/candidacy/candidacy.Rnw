...
dumbRLM1 <- lrm(contest2 ~ VAP_adjLOG + PerBachelorOrAbove + per_white_all + 
                    OOH_share + median_incomeLOG + per65o + 
                    NonWhitePublicPupilPer + NonPublicPupilPer + 
                    teachShareofVoters + locale2 + member_delta_per,
...
dumbRLM1.2 <- lrm(contest2 ~ VAP_adjLOG + PerBachelorOrAbove + per_white_all + 
                    OOH_share + median_incomeLOG + per65o + 
                    NonWhitePublicPupilPer + NonPublicPupilPer + 
                    teachShareofVoters + locale2 + member_delta_per + 
...
dumbRLM2 <- lrm(contest2 ~ VAP_adjLOG + PerBachelorOrAbove + per_white_all + 
                    OOH_share + median_incomeLOG + per65o + 
                    NonWhitePublicPupilPer + NonPublicPupilPer + 
                    teachShareofVoters + locale2 + member_delta_per + 
                    factor(distid), 
...
apsrtable(dumbRLM1, dumbRLM1.2, dumbRLMbest, se="robust", 
          label="tab:lagmods", 
...
fiscalModel <- glm(contest2 ~ balance_member_lag + millrate * NonSDMill + 
                     ...
                     ADJ_MEDIAN_SALARY_TEACHlog + millrate_delta + 
