...
explanatory power for school boards. Next, leveraging a unique dataset that includes the political 
...
dataset allows me to test competing claims about the role that salient policy and 
...
strong test of the policy linkages between levels of government. Leveragint what is 
...
2013, and at the end of the collection period, \Sexpr{SAMPSIZE} districts responded 
with records. 
