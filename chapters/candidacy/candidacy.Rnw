...
selectVars <- c("TOTPOP.x", "toprepshare.x", "member", "econ_disadv_per", 
                ...
                "median_income", "OOH_share", "sample", "balance_lag")

round(t(aggregate(mysub[, selectVars], 
...
As you can see, there is little difference between schools in and out of the sample. 
