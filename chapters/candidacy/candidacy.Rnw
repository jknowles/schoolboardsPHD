...
# moddat$ADMIN_SHARE_COMP <- rescale(moddat$ADMIN_SHARE_COMP)
# moddat$ADMIN_SHARE_FTE <- rescale(moddat$ADMIN_SHARE_FTE)
# moddat$econ_disadv_per <- rescale(moddat$econ_disadv_per)
# moddat$tax_price <- rescale(moddat$tax_price)
# moddat$eqv_taxfiler <- rescale(log(moddat$eqv_taxfiler))
# moddat$totalincome_count <- rescale(moddat$totalincome_count)
...
# moddat$turnoutLag2 <- rescale(moddat$turnoutLag2)
# moddat$partyDivision <- rescale(moddat$partyDivision)
# moddat$fallTwoPartyShareDem <- rescale(moddat$fallTwoPartyShareDem)
...
# moddat$overrideYesPer <- rescale(moddat$overrideYesPer)
# moddat$incumShare <- rescale(moddat$incumShare)
