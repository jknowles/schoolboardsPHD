...
<<politic1, fig.cap="Correlations of Political Variables", fig.height=5, fig.width=5.5>>=
cormat <- melt(round(cor(dist_turn[!is.na(dist_turn$turnout), 
...
<<policy1, fig.cap="Correlations of Policy Variables", fig.height=5, fig.width=5.5>>=
...
<<rocplot1, echo=FALSE, fig.cap="ROC Curves for Models of Election Contestation in Wisconsin School Boards", fig.keep='last', fig.width=5.5, fig.height=5>>=
...
printPB(modTestPolitic1, names = nams2)
