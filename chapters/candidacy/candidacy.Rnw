...
\[ (1) \hspace{1.2 in}  \Pr_CE_{t} = \alpha + \beta X_{t-1} + \gamma Z_{t} + \epsilon \] \\

Here, $\Pr_CE_{t}$ represents the probability that a school board seat is contested 
...
\[ (2) \hspace{1.2 in}  CE_{t} = \alpha + \beta X_{t-1} + \gamma Z_{t} + \epsilon \] \\
