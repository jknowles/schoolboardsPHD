...
moddat <- dist_turn[, c("contestSer", "contestMinor", "distid","year", 
                        ...
                        "tax_price", "eqv_total", "totalincome_count", 
                        "total_cat_aids_member", "contestSerLag", "contestMinorLag",
...
moddat$eqv_taxfiler <- moddat$eqv_total / moddat$totalincome_count
...
biggerModM <- glmer(contestMinor ~ VAP_adjLOG + PerBachelorOrAbove + per_white_all + 
                    OOH_share +  per65o + median_incomeLOG + 
                    NonWhitePublicPupilPer + NonPublicPupilPer + 
                    ADMIN_SHARE_COMP +   
                    districtwide + econ_disadv_per+ 
