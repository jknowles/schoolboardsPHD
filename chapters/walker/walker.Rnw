...
To avoid problems with endogeneity, and because of the long panel nature of the 
...
Contesed Race (ser) & + & null & no statistical significance, wrong sign \\ \hline
...
period does this effect reach statistical signficance. This effect is a bit hard 
...
Some stuff about framing results. 
