...
<<blaisLagoplot, fig.scap="Correlation of Blais-Lago Quotient and Blais-Lago Lag", fig.height=3.7, fig.cap="Correlation of Blais-Lago Quotient and 2x Lag. Point is the correlation coefficient and confidence bands mark the 95 percent confidence interval for the correlation in each year.">>=
...
certification elections, and won \Sexpr{iNum(wercDatTeachers$wins_werc)}. This 
