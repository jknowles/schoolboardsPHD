\chapter{Whad'dya Know?}
\label{chap:theoryreview}
...
% 
% $(1)  \hspace{1.2 in}  CE_{t} = \alpha + \beta X_{t-1} + \gamma Z_{t} + \epsilon $ \\
% 
...
% 
% $(3) \hspace{1.2 in} UP_{i} = \alpha + \beta X_{lag} + \gamma Z_{t} + \theta I_{t} + \epsilon$ \\
% 
...
% 
% 
% $(4) \hspace{1.2 in} B_{i} = \alpha + \beta X_{lag} + \gamma Z_{t} + \theta P_{lag} + \epsilon$\\
% 
