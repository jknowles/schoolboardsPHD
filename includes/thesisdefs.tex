...
\gdef\@committee{
  Jane Doeverything, Professor, Political Science\\
  John Dosomethings, Associate Professor, Political Science\\
}

\gdef\@department{(Political Science)} % Default is Electical Engineering
